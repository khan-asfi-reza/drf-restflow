...
**Current Release:** ({{ version_human }})

**Available Features:** 
- [Filtering](guide/filtering) 
...
The current release ({{ version_human }}) focuses on declarative filtering with these capabilities:
...
- [Installation](getting-started/installation.md) - Install drf-restflow
- [Quick Start Guide](getting-started/quickstart.md) - Build your first FilterSet
- [Basic Concepts](getting-started/concepts.md) - Understand core concepts
- [Filtering Tutorial](tutorial/filtering.md) - Complete filtering guide
...
**Alpha Notice:** This is version {{ version }} - the first alpha release. The filtering API is mostly stable, but breaking changes may occur as we add features and gather community feedback.
